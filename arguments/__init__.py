...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        parser.add_argument('--start_control_cb_iter', type=int, default=40_000)   # default 4w, scannet 5w
        parser.add_argument('--start_follow_cb_iter', type=int, default=50_000)   # default 5w, scannet 7w
    ...
    def extract(self, args):
        ...
        g.start_control_cb_iter = args.start_control_cb_iter
        g.start_follow_cb_iter = args.start_follow_cb_iter
